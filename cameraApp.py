...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.meter_modes = QtWidgets.QComboBox(self.formLayoutWidget_6)
        self.meter_modes.setObjectName("meter_modes")
        self.formLayout_6.setWidget(0, QtWidgets.QFormLayout.FieldRole, self.meter_modes)
        ...
        self.exposure_modes = QtWidgets.QComboBox(self.formLayoutWidget_6)
        self.exposure_modes.setObjectName("exposure_modes")
        self.formLayout_6.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.exposure_modes)
        ...
        self.flash_modes = QtWidgets.QComboBox(self.formLayoutWidget_6)
        self.flash_modes.setObjectName("flash_modes")
        self.formLayout_6.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.flash_modes)
        ...
        self.awb_modes = QtWidgets.QComboBox(self.formLayoutWidget_6)
        self.awb_modes.setObjectName("awb_modes")
        self.formLayout_6.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.awb_modes)
        ...
        self.image_effects = QtWidgets.QComboBox(self.formLayoutWidget_6)
        self.image_effects.setObjectName("image_effects")
        self.formLayout_6.setWidget(4, QtWidgets.QFormLayout.FieldRole, self.image_effects)
        ...
        self.drc_strengths = QtWidgets.QComboBox(self.formLayoutWidget_6)
        self.drc_strengths.setObjectName("drc_strengths")
        self.formLayout_6.setWidget(5, QtWidgets.QFormLayout.FieldRole, self.drc_strengths)
        ...
        self.raw_formats = QtWidgets.QComboBox(self.formLayoutWidget_6)
        self.raw_formats.setObjectName("raw_formats")
        self.formLayout_6.setWidget(6, QtWidgets.QFormLayout.FieldRole, self.raw_formats)
        ...
        self.clock_modes = QtWidgets.QComboBox(self.formLayoutWidget_6)
        self.clock_modes.setObjectName("clock_modes")
        self.formLayout_6.setWidget(7, QtWidgets.QFormLayout.FieldRole, self.clock_modes)
        ...
        self.meter_modes.currentIndexChanged['QString'].connect(MainWindow.setCamValFromCombo)
        self.exposure_modes.currentIndexChanged['QString'].connect(MainWindow.setCamValFromCombo)
        self.flash_modes.currentIndexChanged['QString'].connect(MainWindow.setCamValFromCombo)
        self.awb_modes.currentIndexChanged['QString'].connect(MainWindow.setCamValFromCombo)
        self.image_effects.currentIndexChanged['QString'].connect(MainWindow.setCamValFromCombo)
        self.drc_strengths.currentIndexChanged['QString'].connect(MainWindow.setCamValFromCombo)
        self.raw_formats.currentIndexChanged['QString'].connect(MainWindow.setCamValFromCombo)
        self.clock_modes.currentIndexChanged['QString'].connect(MainWindow.setCamValFromCombo)
